    ...
    QMainWindow(parent)
{
    ...
    adb = new QLineEdit();
    QFont font;
    font.setFamily(QStringLiteral("MS Mincho"));
    ...
    np->setStyleSheet("background-color: rgb(215, 110, 0);font-size:20px;");
    np->setText(QString("Add polynom"));
    QObject :: connect(np, SIGNAL(clicked()), this, SLOT(new_polynom()));
    peq->setStyleSheet("background-color: rgb(133, 133, 133); font-size:15px;");
    peq->setText(QString("Solve"));
    QObject :: connect(peq, SIGNAL(clicked()), this, SLOT(solve_eq()));
    su->setStyleSheet("background-color: rgb(133, 133, 133); font-size:15px;");
    su->setText(QString("+"));
    QObject :: connect(su, SIGNAL(clicked()), this, SLOT(psum()));
    mi->setStyleSheet("background-color: rgb(133, 133, 133); font-size:15px;");
    mi->setText(QString("-"));
    QObject :: connect(mi, SIGNAL(clicked()), this, SLOT(pmin()));
    mu->setStyleSheet("background-color: rgb(133, 133, 133); font-size:15px;");
    mu->setText(QString("*"));
    QObject :: connect(mu, SIGNAL(clicked()), this, SLOT(multiple()));
    di->setStyleSheet("background-color: rgb(133, 133, 133); font-size:15px;");
    di->setText(QString("/"));
    QObject :: connect(di, SIGNAL(clicked()), this, SLOT(division()));
    de->setStyleSheet("background-color: rgb(133, 133, 133); font-size:15px;");
    de->setText(QString("f'(x)"));
    QObject :: connect(de, SIGNAL(clicked()), this, SLOT(derivative()));
    po->setStyleSheet("background-color: rgb(133, 133, 133); font-size:15px;");
    ...
    sclc->setStyleSheet("background-color: rgb(215, 110, 0); font-size:15px;");
    ...
    layout->addWidget(su, 3, 0, 1, 1);
    layout->addWidget(mi, 3, 1, 1, 1);
    layout->addWidget(mu, 3, 2, 1, 1);
    layout->addWidget(di, 3, 3, 1, 1);
    layout->addWidget(de, 3, 4, 1, 1);
    layout->addWidget(po, 3, 5, 1, 1);
    layout->addWidget(peq, 3, 6, 1, 1);
    layout->addWidget(insp1, 2, 0, 1, 1);
    layout->addWidget(errc1, 4, 0, 1, 2);
    layout->addWidget(clcp, 4, 2, 1, 1);
    layout->addWidget(ans, 4, 3, 1, 4);
    layout->addWidget(sclc, 5, 3, 1, 1);
    layout->addWidget(insp2, 2, 3, 1, 1);
